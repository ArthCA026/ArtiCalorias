...
/**
 * Single icon system for the whole app. Stroke-based, lucide-style.
 * Usage: <Icon name="flame" size={20} className="text-streak" />
 */
...
const paths: Record<string, ReactElement> = {
  ...
  star: (
    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7.32 14.14 2.32 9.27l6.91-1.01z" />
  ),
  crown: (
    <path d="M3 7l4.5 3.5L12 4.5l4.5 6L21 7l-1.8 11a1 1 0 0 1-1 .84H5.8a1 1 0 0 1-1-.84z" />
  ),
  gift: (
    <>
  ...
  sparkles: (
    <>
      <path d="M12 4l1.7 5a2 2 0 0 0 1.3 1.3l5 1.7-5 1.7a2 2 0 0 0-1.3 1.3L12 20l-1.7-5a2 2 0 0 0-1.3-1.3L4 12l5-1.7a2 2 0 0 0 1.3-1.3z" />
      <path d="M5 3v4" />
      <path d="M3 5h4" />
    </>
  ),
  ...
  flag: (
    <>
      <path d="M4 22V4a1 1 0 0 1 .4-.8A6 6 0 0 1 8 2c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0 1 20 4v10a1 1 0 0 1-.4.8A6 6 0 0 1 16 16c-3 0-5-2-7.333-2q-2 0-3.067.8" />
    </>
  ),
  heart: (
  ...
  ruler: (
    <>
      <path d="M21.3 15.3a2.4 2.4 0 0 1 0 3.4l-2.6 2.6a2.4 2.4 0 0 1-3.4 0L2.3 8.7a2.4 2.4 0 0 1 0-3.4l2.6-2.6a2.4 2.4 0 0 1 3.4 0Z" />
...
interface IconProps {
  ...
  strokeWidth?: number;
  className?: string;
  /** Inline style, e.g. a token-driven color: style={{ color: 'var(--t-water)' }} */
