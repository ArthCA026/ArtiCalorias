...
const CHANGELOG: Release[] = [
  {
    version: "1.2.0",
    date: "2026-05-15",
    summary: "Mobile tab bar and navigation overhaul.",
    changes: [
      { type: "new",      text: "Bottom tab bar on mobile replaces the hamburger menu for faster one-thumb navigation" },
      { type: "new",      text: "Today is centered in the tab bar as the primary destination" },
      { type: "improved", text: "Logout button replaces the hamburger icon in the mobile header" },
      { type: "improved", text: "Reduced top spacing on mobile for a tighter, more content-focused layout" },
    ],
  },
  {
    version: "1.1.1",
