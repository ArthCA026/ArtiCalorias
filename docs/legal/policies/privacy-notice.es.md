...
> **BORRADOR PARA REVISIÓN LEGAL.** Versión 2026-09-09, vigente desde 2026-09-09.
> Copia canónica del texto mostrado en la app (`Articalorias.UI/src/legal/content/privacy.es.ts`).
...
Para funcionar, ArtiCalorias envía ciertos datos a estos proveedores:
...
## Datos obligatorios, opcionales y consecuencias de no darlos
