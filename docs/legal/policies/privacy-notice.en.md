...
Account data, required to create an account:
...
To work, ArtiCalorias sends certain data to these providers:
...
## Required data, optional data, and what happens if you decline
